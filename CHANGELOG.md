...
* Fix lsblk JSON output utf-8 encoded characters [Lorenzo Alberto Maria Ambrosi]
...
* Feat(diskutil): Populate devicePath on Mac OS [Jonas Hermsmeier]
* Fix(diskutil): Also probe Ejectable to determine removabililty [Jonas Hermsmeier]
